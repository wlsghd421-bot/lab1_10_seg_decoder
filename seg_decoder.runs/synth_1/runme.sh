...
HD_PWD='C:/Users/wlsgh/lab1_10_seg_decoder/seg_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_decoder.tcl
