...
HD_PWD='C:/Users/wlsgh/lab1_10_seg_decoder/seg_decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_decoder.tcl -notrace
